...
public class PathResolveMI implements MethodInserter {
    ...
    public void insert(ClassNode classNode, MethodNode targetMethod, RuntimeDepCollector depCollector, DowngradeResult result) {
        ...
        // this Path
        code.add(new MethodInsnNode(Opcodes.INVOKEINTERFACE, "java/nio/file/Path", "resolve", "(Ljava/nio/file/Path;)Ljava/nio/file/Path;"));
        // Path
