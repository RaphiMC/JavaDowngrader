...
public class PathEndsWithMI implements MethodInserter {
    ...
    public void insert(ClassNode classNode, MethodNode targetMethod, RuntimeDepCollector depCollector, DowngradeResult result) {
        ...
        // this Path
        code.add(new MethodInsnNode(Opcodes.INVOKEINTERFACE, "java/nio/file/Path", "endsWith", "(Ljava/nio/file/Path;)Z"));
        // boolean
